...
const { expect } = chai
const { calculateAmountOfOreForFuel, maximumFuelForATrillionOre } = require('./main')
...
describe('day 14', () => {
  ...
  describe('part a examples', () => {
    examples.forEach(([instructions, oreCount], idx) => {
      it(`should calculate the correct amount of ORE for FUEL for scenario ${idx} `, () => {
        expect(calculateAmountOfOreForFuel(instructions)).to.equal(oreCount)
      })
    })
  })
